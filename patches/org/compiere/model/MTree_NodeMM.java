...
public class MTree_NodeMM extends X_AD_TreeNodeMM
{
	...
	/*public static MTree_NodeMM1 get (MTree_Base tree, int Node_ID)
	{
		MTree_NodeMM1 retValue = null;
		...
		try
		{
			...
			if (rs.next ())
				retValue = new MTree_NodeMM1 (tree.getCtx(), rs, tree.get_TrxName());
			rs.close ();
			pstmt.close ();
			pstmt = null;
		}
	 ...
	 */
	//	Yamel Senih, Old method
	/*public MTree_NodeMM1 (MTree_Base tree, int Node_ID)
	{
