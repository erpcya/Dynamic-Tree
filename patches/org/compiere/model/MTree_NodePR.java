...
public class MTree_NodePR extends X_AD_TreeNodePR
{
	...
	/*public static MTree_NodePR1 get (MTree_Base tree, int Node_ID)
	{
		MTree_NodePR1 retValue = null;
		...
		try
		{
			...
			if (rs.next ())
				retValue = new MTree_NodePR1 (tree.getCtx(), rs, tree.get_TrxName());
			rs.close ();
			pstmt.close ();
			pstmt = null;
		}
	 ...
	 *	@param Node_ID node
	 */
	//	Yamel Senih, Old metod
	/*public MTree_NodePR1 (MTree_Base tree, int Node_ID)
	{
